...
//	"log"
//
//	pb "gitlab.com/booknest1/book-service/genproto/books"
//	"gitlab.com/booknest1/book-service/service"
//
...
//	return func(message []byte) {
//		var req pb.PublishersCreateReq
//		if err := protojson.Unmarshal(message, &req); err != nil {
//			log.Printf("Cannot unmarshal JSON: %v", err)
//			return
//		}
...
//	return func(message []byte) {
//		var req pb.TranslatorsCreateReq
//		if err := protojson.Unmarshal(message, &req); err != nil {
//			log.Printf("Cannot unmarshal JSON: %v", err)
//			return
//		}
...
//	return func(message []byte) {
//		var req pb.CategoriesCreateReq
//		if err := protojson.Unmarshal(message, &req); err != nil {
//			log.Printf("Cannot unmarshal JSON: %v", err)
//			return
//		}
